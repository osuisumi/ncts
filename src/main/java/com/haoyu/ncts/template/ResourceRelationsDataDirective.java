...
@Component
public class ResourceRelationsDataDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body)
		...
		if (params.containsKey("resource") && params.get("resource") != null) {
			...
			if (beanModel != null) {
				...
				List<ResourceRelation> resourceRelations = resourseBizService.listResourceRelation(resource, pageBounds);
//				List<Resources> resources = resourseBizService.listResource(resource, pageBounds);
				env.setVariable("resourceRelations", new DefaultObjectWrapper().wrap(resourceRelations));
				if (pageBounds != null && pageBounds.isContainsTotalCount()) {
					PageList pageList = (PageList)resourceRelations;
