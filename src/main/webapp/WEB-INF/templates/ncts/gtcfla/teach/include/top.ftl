<#macro topFtl>
	<div id="g-hd">
	    <div class="g-auto">
	        <h1 id="m-logo">
	            <a href="/">
	                <img src="${app_path}/images/logo.png" alt="${PropertiesLoader.get('app.name')}培训平台课程制作中心">
	                <span>${PropertiesLoader.get('app.name')}培训平台课程制作中心</span>
	            </a>
	        </h1>
	        <ul class="m-tp-opt">
	            <li class="user">
 				...
 				<li class="g-notice">
					<a onclick="loadMore()" href="javascript:void(0);" class="u-bell"><i class="u-bell-ico"></i>消息</a>
