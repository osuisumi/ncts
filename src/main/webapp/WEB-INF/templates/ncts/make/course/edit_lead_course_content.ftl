...
<@layout>
			                                        ...
			                                        <div class="optRow">
			                                            ...
			                                            <div class="dataBlock">
			                                                <div class="m-pbMod-ipt date">
			                                                    <input name="dateTime" type="text" value="${(section.timePeriod.startTime?string("yyyy/MM/dd"))!}" onFocus="WdatePicker({oncleared:function(){clearSectionDate('${section.id}')},onpicked:function(){updateSectionConfig('${section.id}')},minDate:'${.now?date}',dateFmt:'yyyy/MM/dd'})" class="u-pbIpt">
			                                                </div>
			                                            </div>
			                                            <div class="timeBlock">
		                                                <div class="m-selectbox style1">
		                                                    <strong><span class="simulateSelect-text">0</span><i></i></strong>
			                                                    <select id="hourSelect_${section.id!}" name="dateTime" onchange="updateSectionConfig('${section.id}')">
			                                                    	<#list 0..23 as i>
			                                                    ...
			                                                    <script>
			                                                    	$(function(){
			                                                    		$('#hourSelect_${section.id!}').simulateSelectBox({
		                                                ...
		                                                <div class="m-selectbox style1">
		                                                    <strong><span class="simulateSelect-text">0</span><i></i></strong>
			                                                    <select id="minuteSelect_${section.id!}" name="dateTime" onchange="updateSectionConfig('${section.id}')">
			                                                    	<#list 0..59 as i>
			                                                    		<option value="${i}">${i}</option>
			                                                    	</#list>
			                                                    </select>
			                                                    <script>
			                                                    	$(function(){
			                                                    		$('#minuteSelect_${section.id!}').simulateSelectBox({
	...
	function editSectionConfig(id){
		mylayerFn.open({
	        ...
	        fix: false,
	        area: [600, 420],
	        content: '${ctx}/make/section/'+id+'/editSectionConfig',
	        shadeClose: false
	    });
	}
	...
	function addActivity(type){
		...
		mylayerFn.open({
	        ...
	        content: '${ctx}/'+activityRelationId+'/make/activity/create?type='+type,
	        shadeClose: false
	    });
	}
