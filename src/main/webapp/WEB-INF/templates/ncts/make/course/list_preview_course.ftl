            ...
            <div class="g-innerAuto g-addCourse-cont">
                <div class="g-addcourse-dt">
                    <div class="g-CourseList-tp">
                        <h2 class="tt">课程预览<span>Course Making</span></h2>
                        <label class="m-srh">
                    ...
                    <div class="g-courseList-bd">
                        <div class="g-clist-optRow">
                            <div id="stateTab" class="m-clist-tabli">
                                <a state="" href="javascript:void(0);" class="z-crt"><span>全部</span><i class="trg"></i></a>
                            </div>
                        ...
                        <div class="g-clist-tabcon">
                            <div class="g-clist-cont">
                            	<@coursesDirective title=(course.title)!'' listMode=listMode!'' isTemplate='Y' page=(pageBounds.page)!1 limit=(pageBounds.limit)!12 orders='CREATE_TIME.DESC' >
